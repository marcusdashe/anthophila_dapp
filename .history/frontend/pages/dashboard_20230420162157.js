...
const Dashboard = () => {
  ...
  const [action, setAction] = useState("Store Will");

  const actions = [
    {
      action_type: "Store Will",
      action_name: "Store Will IPFSCID",
    },
    {
      action_type: "Add Beneficiary",
      action_name: "Add Beneficary By Address",
    },
    {
      action_type: "Fetch Beneficiary",
      action_name: "Fetch Beneficiary By Address",
    },
    {
      action_type: "Fetch Beneficiaries",
    ...
    {
      action_type: "Remove Beneficiary",
